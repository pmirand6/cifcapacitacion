...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030"> 
  ...
  <body>
        ...
        <nav class="main-nav navbar-fixed-top headroom headroom--pinned"> 
            <div class="container"> 
                ...
                <div class="navbar-header"> 
                    ...
                    <a href="/"> 
                        <img id="logo-cabecera" href="/" src="images/logo-header.png" class="brand-img img-responsive" alt="CIF Capacitacion Pacheco"> 
                    </a>                         
                </div>                     
                <!-- Navigation -->                     
    ...
    <!--<script src="js/bootstrap.min.js"></script>         este tambien-->
...
<!--<script type="text/javascript" src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> este tambien -->
