            ...
            <div class="top-content fade in active" id="tab1">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="resumen">
                            <p class="lead">
                                Este curso está dirigido a todas las personas involucradas en la Logística de empresas, operadores logísticos, profesionales
                                del comercio exterior y estudiantes de otras disciplinas que quieran desarrollar mayores
                                conocimientos sobre el tema.</p>
                        </div>
                        <div class="container fecha">
                            <h3 class="oferta_fecha_texto">El curso comienza:</h3>
                            <h3 class="oferta_fecha_fecha">JULIO</h3>
                        </div>
                        <div class="container">
                        ...
                        <div class="row">
                            <!--<div class="col-sm-5 col-xs-12"> 
                                <a href="#modal_inscripcion" class="btn btn-block btn-primary"><span class="fa fa-cloud-upload"></span> Inscribite</a>
                            </div>-->
                            <div class="col-sm-5 col-xs-12">
                    ...
                    <div class="col-sm-5 col-sm-offset-1">
                        <img class="imagen-curso img-rounded img-responsive" src="images/logistica.png" alt="Operador de Logistica">
                    </div>
                </div>
                <!--<div class="container">
                    <div class="row detalle">
                            ...
                            <div class="panel-group">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="#temas" data-toggle="collapse" data-parent=".panel-group" class="panel-title">Contenido del Curso</a></h4>
                                    </div>
                                    <div id="temas" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ul class="detalle2"> 

                                                <li id="des_li">Rol del Asistente Dental</li>                                                     
                                                <li id="des_li">Bioseguridad (medidas preventivas)</li>                                                    
                                                <li id="des_li">Esterilización</li>                                                     
                                                <li id="des_li">Patología Dentaria, etiología de diferentes caries, pulpitis.</li>                                                     
                                                <li id="des_li">Anatomía Dentaria (interno y externo)</li>                                                     
                                                <li id="des_li">Radiología, procesado.</li>                                                     
                                                <li id="des_li">Materiales Dentales, restauración y reconstrucción.</li>                                                     
                                                <li id="des_li">Prótesis, distintos tipos.</li>                                                     
                                                <li id="des_li">Cirugía: Habito y ámbito quirúrgico.</li>                                                     
                                                <li id="des_li">Reconocimiento del instrumental quirúrgico, armado de mesa.</li>                                                     
                                                <li id="des_li">Implantes Dentales.</li>                                                     
                                                <li id="des_li">Reconocimiento de instrumental de periodoncia  operatoria y endodoncia.</li>                                                     
                                                <li id="des_li">Diseño y Armado de CV</li>                                                     
                                                <li id="des_li">Entrevista Laboral (roll play)</li>                                                     
                                            </ul>                                                 
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-5 col-xs-12">
                            <div class="panel-group2">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="#egresado" data-toggle="collapse" data-parent=".panel-group2">Perfil del Egresado</a></h4>
                                    </div>
