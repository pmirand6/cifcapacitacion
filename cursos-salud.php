            ...
            <div class="top-content" id="tab2">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="resumen">
                            <p class="lead">
                                La actividad del Mecánico dental es colaborar estrechamente con el odontólogo en la confección de prótesis dentales, con
                                gran capacidad técnica y formación científica. El egresado logra insertarse en el medio laboral
                                conformando un equipo de trabajo con el odontólogo, confeccionando las prótesis que el odontólogo
                                planifica, diseña e instala en la boca del paciente, cumpliendo la función de auxiliar del
                                mismo.
                            </p>
                        </div>
                        <div class="container fecha">
                            <h3 class="oferta_fecha_inscripcion">Inscripciones Abiertas todo el
                                <strong>AÑO</strong>
                            </h3>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <p>
                                <em class="em">Una clase semanal de 2 1/2 horas</em>
                            </p>
                        </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a href="#temas-mecanica" data-toggle="collapse" data-parent=".panel-mecanica" class="panel-title">Contenido del Curso</a>
                                        </h4>
                                    </div>
                                    <div id="temas-mecanica" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ul class="detalle2">
                                                ...
                                                <li id="des_li">Prótesis Flexibles (poliamidas distintas densidades)</li>
                                ...
                                <div class="col-sm-5 col-xs-12">
                                    <div class="panel-mecanica-egresado">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a href="#egresado-mecanica" data-toggle="collapse" data-parent=".panel-mecanica-egresado">Perfil del Egresado</a>
                                                </h4>
                                            </div>
                                            <div id="egresado-mecanica" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    <ul class="detalle2">
                                                        ...
                                                        <li> Conocimiento de los procesos de trabajo, en el uso de Hornos para
                                                            metales y cerámica</li>
            ...
            <div class="top-content fade in active" id="tab1">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="resumen">
                            <p class="lead">
                                Los asistentes dentales se ven a menudo como miembros fundamentales de un equipo dental, sumando su conocimiento y aptitudes
                                para el trabajo en conjunto con el odontologo y el personal administrativo</p>
                        </div>
                        <div class="container fecha">
                        ...
                        <div class="col-sm-5 col-xs-12">
                            <div class="panel-asistente">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a href="#temas" data-toggle="collapse" data-parent=".panel-asistente" class="panel-title">Contenido del Curso</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="col-sm-5 col-xs-12">
                                    <div class="panel-asistente-egresado">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a href="#egresado" data-toggle="collapse" data-parent=".panel-asistente-egresado">Perfil del Egresado</a>
                                                </h4>
                                            </div>
            ...
            <div class="top-content fade in active" id="tab2">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="resumen">
                            <p class="lead">
                                Los auxiliares de farmacia trabajan como parte de un equipo de farmacia bajo la dirección de un farmacéutico registrado.
                                Usted será responsable de tratar con los clientes, la reposición de la farmacia, la tipificación
                                de recetas, y otras tareas de oficina</p>
                        </div>
                        <div class="container fecha">
                            <h3 class="oferta_fecha_texto">El curso comienza:</h3>
                            <h3 class="oferta_fecha_fecha">
                        ...
                        <div class="col-sm-5 col-xs-12">
                            <div class="panel-farmacia">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a href="#temas-aux_farmacia" data-toggle="collapse" data-parent=".panel-farmacia" class="panel-title">Contenido del Curso</a>
                                        </h4>
                                    </div>
                                ...
                                <div class="col-sm-5 col-xs-12">
                                    <div class="panel-farmacia-egresado">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a href="#egresado-farmacia" data-toggle="collapse" data-parent=".panel-farmacia-egresado">Perfil del Egresado</a>
                                                </h4>
                                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="services-wrapper">
                        <div class="col-md-4" data-aos="fade-left" data-aos-duration="850">
                            ...
                            <p>Desarrollo de Talleres vocacionales para adquirir las herramientas necesarias para direccionar
                                tu futura actividad laboral.</p>
                        </div>
                        <div class="col-md-4" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <p>Diseño y armado de un Curriculum Vitae atractivo para participar de futuras postulaciones a entrevistas
                                laborales.
                            </p>
                        </div>
