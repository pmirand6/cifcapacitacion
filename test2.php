...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp"> 
  ...
  <link rel="stylesheet" href="components/pg.blocks/css/gallery.css"> 
	...
	<section>
		...
		<div class="container gallery-container">
			...
			<div class="tz-gallery">
                <p class="page-description text-center">Cursos de Salud</p>
				<div class="row">
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							<a class="lightbox" href="images/mecanica.png">
								<img src="images/mecanica.png" alt="Park">
							</a>
							<div class="caption">
								<h3>Mecanica Dental</h3>
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							<a class="lightbox" href="images/auxiliar.png">
								<img src="images/auxiliar.png" alt="Bridge">
							</a>
							<div class="caption">
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							<a class="lightbox" href="images/asistente-dental.png">
								<img src="images/asistente-dental.png" alt="Tunnel">
							</a>
							<div class="caption">
        ...
        <div class="container gallery-container text-center">
			<div class="tz-gallery">
                <p class="page-description text-center">Cursos de Gastronomia</p>
				<div class="row">
					<div class="col-sm-6 col-md-4">
                        <div class="center-block">
                        <div class="thumbnail">
							<a class="lightbox" href="images/mecanica.png">
								<img src="https://www.meldmagazine.com.au/wp-content/uploads/2016/11/meld-waitress-waiter-service-hospitality-2.jpg" alt="Park">
							</a>
							<div class="caption">
								<h3>Mozo</h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
