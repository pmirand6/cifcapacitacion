        ...
        <div class="top-content fade in active" id="tab1"> 
          ...
          <div class="row"> 
            <div class="col-sm-6"> 
              <div class="resumen"> 
                <p class="lead"> 
                 El curso de reparación de Aire Acondicionado te ofrece una formación integral que te permitirá una rápida salida laboral, disponiendo de una capacitación que abarcará temas comunes a la reparación y mantenimientos de los distintos equipos de Aire Acondicionado.</p> 
               </div>                             
            ...
            <div class="row detalle">
                ...
                <div class="panel-group">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="panel-title"><a href="#temas" data-toggle="collapse" data-parent=".panel-group" class="panel-title">Teoria</a></h4>
                    </div>
                    <div id="temas" class="panel-collapse collapse">
                      <div class="panel-body">
                        <ul class="detalle2"> 

                          <li id="des_li">Electricidad: conceptos, distribución monofásica, unidades de medida, instrumental eléctrico, circuitos y conexionado.</li>
                          ...
                          <li id="des_li">Descripción de las partes que componen un sistema de aire acondicionado, condensador, evaporador, elementos de expansión, filtros, válvula inversora.</li>
              ...
              <div class="col-sm-5 col-xs-12">
                <div class="panel-group3">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="panel-title"><a href="#practica" data-toggle="collapse" data-parent=".panel-group3" class="panel-title">Practica</a></h4>
                    </div>
